var _0x5707 = ['nonr-t', 'addClass', '.two\x20.owl-next', 'owlCarousel', '.item', '.slider-two\x20.left-t', '.disabled',
	'width', '.left', '.slider\x20.owl-dots\x20.owl-dot', '.right', '.left-t', '.main\x20.owl-next', 'nonl-t',
	'.slider\x20.owl-prev', 'removeClass', '.slider\x20.owl-next', '.slider-two\x20.item', 'active', 'ready',
	'.slider-two\x20.owl-prev', '.slider-two\x20.owl-dots\x20.owl-dot', 'click', 'nonr', '.right-t',
	'.slider-two\x20.owl-next', '.thumbs', 'trigger', 'index', 'translated.owl.carousel', '.slider-two\x20.right-t',
	'.main', 'nonl', '.thumbs\x20.owl-prev', '.main\x20.owl-prev', '.slider\x20.owl-item.active'
];
